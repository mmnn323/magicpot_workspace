...
<style>
   ...
   .outer{
      ...
      #proOkBtn{width:150px; margin-right:10px; padding:8px; background-color: rgb(116, 152, 107); border:none;}
      ...
      #proOkBtn:hover{background-color: rgb(225, 212, 169);}
</style>
</head>
<body>
	 ...
	 <div class="outer" >
             ...
             <form action="" id="enrollForm" method="post" enctype="">
                 <div id="pro_listArea2" >
                     <table id="pro_enrollTable">
                         <tr>
                             <td colspan="2">
                                 <input type="text" name="title" id="pro_title" placeholder="제목을 입력해주세요" required>
                             </td> 
                         </tr>
                         <tr>
                             <td colspan="2" >
                 ...
                 <div id="pro_btnArea" align="center">
                     <a href="#" id="pro_enrollBtn" class="btn btn-success" data-toggle="modal" data-target="#proEnrollBtn">등록하기</a>
        ...
        <!-- The Modal -->
        <div class="modal fade" id="proEnrollBtn" align="center">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" >
                    ...
                    <div id="proModalFooter">
                        <button id="proOkBtn" class="btn btn-warning">등록</button>
