...
<body>
	...
	<div id="outer">
		...
		<div id="content3">
			<div id="content3_1">
				<h5>
					<b>안녕하세요, 건강한 지구를 위한 아름다운 습관, 컨티뉴어스! 입니다.</b>
				</h5>
				<p>제가 아이 둘 엄마가 되면서부터, 그 전에는 생각해 본 적 없던 환경문제가 신경쓰이기 시작했습니다. '앞으로
					우리 아이들이 커서 어떤 직업을 갖고 어떤 모습으로 살아가게 될까?' 가 아니라, '우리 아이들이 깨끗한 공기, 안전한
					물을 마시기나 할 수 있을까? 장래희망을 꿈꾸기보다, 생존을 더 걱정하는 삶을 살게 되진 않을까?' 라는 생각이
					들었습니다. 아이들이 마음껏 꿈을 펼칠 수 있길 바라며 시작한 컨티뉴어스는 지구에 해를 덜 끼치는 친환경 소재와 사용자의
					편의성을 고려한 생활필수품을 연구, 개발하고 있습니다. 다양한 정보와 소식은 인스타그램을 통해 공유하며 많은 사람들과
					소통하고 있습니다.</p>
				...
				<p>컨티뉴어스의 첫 펀딩 프로젝트는 최소 오십만원 (500,000원)의 예산을 목표로, 제작비와 친환경 포장비,
					인쇄비 및 배송비를 포함합니다.</p>

				<h5>
					<b>제작 일정</b>
				</h5>
				<p>- 여름부터 시작된 이 프로젝트는 현재, 지구에 덜 해를 끼치는 시설을 갖춘 곳이면서 동시에 바느질할
					노동자들을 알맞게 대우해주는 믿을 수 있는 시설을 갖춘 업체를 찾았습니다. 현재 샘플 제작 및 제품 테스트까지
					완료되었고, 실제 제품 제작과 패키지 디자인 수정만 남겨두고 있습니다. - 결제가 완료되고 7일 후인 2021년 1월
					24일부터 택배 배송이 시작됩니다. - 제주 및 도서산간 지방으로 받아보실 분은 밀어주기 금액에 3,000원을 추가
					부탁드립니다.</p>
				...
				<b>포장</b> <span> - 컨티뉴어스는 배송/포장도 지구를 생각합니다. 비닐, 뽁뽁이, 택배봉투, 일반
					박스테이프는 일절 사용하지 않고 종이테이프, 종이뽁뽁이, 종이택배상자, 한지 포장을 선호합니다. </span> <br> <b>배송관련</b>
				<span> - 모든 리워드(구성)에는 배송비 3,000원이 포함되어 있습니다. </span> <br> <b>펀딩
					이후 구매 방법</b><br> <span> - 펀딩 종료 후 구매를 원하실 경우, 잔여 재고에 한해
					컨티뉴어스 공식 스토어에서 구매 가능합니다. (공식 스토어 :
					smartstore.naver.com/continuearth) - 현재 인스타그램 @continuearth 에서 지구에
					무해한 생활을 위한 정보나 다양한 다른 생활필수품들에 관한 이야기들을 서로 공유하고 소통 중입니다. 많은 관심
					부탁드립니다. </span>
