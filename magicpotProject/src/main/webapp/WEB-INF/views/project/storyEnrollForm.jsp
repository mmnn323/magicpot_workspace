    ...
    <div class="wrap">
        ...
        <div id="content">
            <div id="content1">
                ...
                <br><br>
                <form action="updateStory.pro" id="updateStory" method="post">
                    ...
                    <textarea name="proSummary" id="proSummary" cols="80" rows="5" maxlength="250" style="resize: none;width: 70%;" onkeyup="fn_checkByte(this)" required>${ project.proSummary }</textarea><br>
                    ...
                    <c:choose>
                    	<c:when test="${ project.proAd eq 'N' }">
                    		<button type="button" id="agreeBtn1"  data-toggle="modal" data-target="#agree"><i class="fas fa-check"></i> 동의하기</button>
                    	</c:when>
                    	<c:when test="${ project.proAd eq 'Y' }">
                    		<button type="button" id="agreeBtn1"  data-toggle="modal" data-target="#agree2"><i class="fas fa-check"></i> 동의완료</button>
                    	</c:when>
                    </c:choose>
                    <br><br><br><br>
                    ...
                    <c:choose>
                    	<c:when test="${ empty project.proStory }">
		                    <div id="story">
		                        <textarea id="summernote" name="proStory" required>
                    	...
                    	<c:when test="${ ! empty project.proStory }">
                    		<div id="story">
		                        <textarea id="summernote" name="proStory" required>${ project.proStory }</textarea>
		                    </div>
                    	</c:when>
                    </c:choose>
                    <br><br>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="btn" style="margin:auto">
                                <button type="button" id="agreeBtn2" data-dismiss="modal" onclick="location.href='agreeCheck.pro';" style="width: 170px;" disabled>스토리 작성 시작하기</button>
                            </div>
                        </div>
                      </div>
                    </div>
                ...
                <script>
                    ...
                    $(function(){
                        $("[name=checkAll]").click(function(){
                            ...
                            if($("[name=checkAll").is(":checked") == true && $("[name=agreeCheck]").is(":checked") == true){
                            	console.log($("[name=agreeCheck]").is(":checked"));
                                $("#agreeBtn2").removeAttr("disabled");
                            }else{
                                $("#agreeBtn2").attr("disabled", true);
                                console.log($("[name=agreeCheck]").is(":checked"));
                            }
                        });
